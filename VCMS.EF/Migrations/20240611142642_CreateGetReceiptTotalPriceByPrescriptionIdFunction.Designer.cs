...
namespace VCMS.EF.Migrations
{
    ...
    [Migration("20240611142642_CreateGetReceiptTotalPriceByPrescriptionIdFunction")]
    partial class CreateGetReceiptTotalPriceByPrescriptionIdFunction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VCMS.Core.Models.Diagnosis", b =>
                {
                    ...
                    b.HasIndex(new[] { "Name" }, "UIX_Diagnostics_Name")
                        .IsUnique();
            ...
            modelBuilder.Entity("VCMS.Core.Models.Doctor", b =>
                {
                    ...
                    b.HasIndex(new[] { "Email" }, "UIX_Doctors_Email")
                        .IsUnique();
            ...
            modelBuilder.Entity("VCMS.Core.Models.Medication", b =>
                {
                    ...
                    b.HasIndex(new[] { "GenericName" }, "UIX_Medication_GenericName")
                        .IsUnique()
                        .HasFilter("[GenericName] IS NOT NULL");
            ...
            modelBuilder.Entity("VCMS.Core.Models.Species", b =>
                {
                    ...
                    b.HasIndex(new[] { "Name" }, "UIX_Species_Name")
                        .IsUnique();
